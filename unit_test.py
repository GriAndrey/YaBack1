...
def test_all():
    ...
    print(f'630 elements import and 504 elements delete test took:{t2 - t1} seconds')
    print(f'100 nodes test took:{t4 - t3} seconds')
    print(f'100 sales test took:{t6 - t5} seconds')
    print(f'100 stats test took:{t8 - t7} seconds')
